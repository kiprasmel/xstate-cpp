...
const Interpreter& Interpreter::onStart(const std::function<void(const Interpreter self)> callback) {
...
Interpreter& Interpreter::onTransition(const std::function<const void(const Interpreter& self)> callback = [](const Interpreter& self) {}) {
...
Interpreter& Interpreter::onStop(const std::function<const void(const Interpreter& self)> callback = [](const Interpreter& self) {}) {
