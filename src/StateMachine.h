...
struct StateMachineState {
	...
	std::string stringify(StateMachineState& self, size_t depth = 0, const bool firstOnNewline = false) const;
};
...
class StateMachine {
	...
	std::string stringify(StateMachine& self, size_t depth = 0, const bool firstOnNewline = false) const;
