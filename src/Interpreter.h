...
struct Interpreter {
	 ...
	 */
	private:
	std::function<void(const Interpreter self)> handleOnStart      = [](const Interpreter self) {};
	std::function<void(const Interpreter self)> handleOnTransition = [](const Interpreter self) {};
	std::function<void(const Interpreter self)> handleOnStop       = [](const Interpreter self) {};
	...
	Interpreter onTransition(const std::function<void(const Interpreter self)> callback);

	Interpreter onStop      (const std::function<void()> callback);
	Interpreter onStop      (const std::function<void(const Interpreter self)> callback);
};
